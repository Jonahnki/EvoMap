export const mockOutbreakData = [
  {
    ...
    description:
      "Highly transmissible COVID-19 variant first detected in India",
  },
  {
    id: "2",
  ...
  },
  {
    ...
    description:
      "Highly lethal hemorrhagic fever virus outbreak contained through rapid response",
  },
  {
    id: "4",
    ...
    status: "active" as const,
    description:
      "Multi-drug resistant tuberculosis strain spreading in urban areas",
  },
  {
    id: "5",
    name: "Candida auris",
    ...
    status: "monitoring" as const,
    description:
      "Antifungal-resistant yeast causing healthcare-associated infections",
  },
];
