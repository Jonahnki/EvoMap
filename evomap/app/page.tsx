        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">EvoMap</h1>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            <p className="text-gray-600 mb-6">
              Democratizing access to evolutionary viral and bacterial outbreak
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Interactive map showing outbreak locations and pathogen
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Visualize evolutionary relationships and mutation patterns
                  across viral lineages.
                </p>
                <Link
                  href="/phylogenetic"
                  className="text-blue-600 hover:text-blue-800 font-medium"
              ...
              <div className="bg-white border border-gray-200 rounded-lg p-6 hover:shadow-md transition-shadow">
                ...
                <p className="text-gray-600 mb-4">
                  Search and filter data by pathogen, location, mutations, and
                  time period.
                </p>
                <Link
                  href="/search"
