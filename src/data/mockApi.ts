  ...
  async getSpeciesInfo(speciesName: string): Promise<SpeciesInfo | null> {
    ...
    const mockSpeciesData: Record<string, SpeciesInfo> = {
      "Homo sapiens": {
        ...
        description:
          "Modern humans, the only extant members of the subtribe Hominina.",
      },
      "Pan troglodytes": {
        ...
        description:
          "Common chimpanzee, our closest living relative sharing ~98.8% DNA similarity.",
      },
    };
...
export const treeUtils = {
  ...
  calculateTreeStats(newick: string): {
    nodeCount: number;
    maxDepth: number;
    leafCount: number;
  } {
